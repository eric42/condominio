...
{
    public partial class ConsultarManutPrev : System.Web.UI.Page
    {
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            SqlDataSource1.SelectParameters["ManutPrevEstrutura"].DefaultValue = txtPesquisar.Text;
        ...
        protected void gdvManut_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/DetalheManutPrev.aspx?id=" + row.Cells[5].Text);
        }
    }
}
