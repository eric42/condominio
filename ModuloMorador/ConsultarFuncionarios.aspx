<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarFuncionarios.aspx.cs" Inherits="CondominioSite.ModuloMorador.ConsultarFuncionarios"  MasterPageFile="~/ModuloMorador/Site1.Master"%>
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT CondFuncNome AS Funcionario, CondFuncSituacao, Funcao, Servico FROM Funcionarios WHERE (CondFuncNome LIKE '%' + @CondFuncNome + '%') AND (IDCond = @IDCond)">
                        <SelectParameters>
